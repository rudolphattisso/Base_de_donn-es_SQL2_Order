...
INSERT INTO client (id, first_name, last_name, email, city, password) VALUES
...
(8, 'Maurice', 'Huet', 'maurice.citymareuil@example.com', 'citymareuil', 'd03f9d34194393019e6d12d7c942827ebd694443'),
...
CREATE TABLE IF NOT EXISTS customer_order (
  ...
  total_price_cache float NOT NULL,
  PRIMARY KEY (id)
);

INSERT INTO customer_order (id, client_id, purchase_date, reference, total_price_cache) VALUES
...
INSERT INTO order_line (id, order_id, last_name, quantity, unit_price, total_price) VALUES
...
/** Pramétrage de la séquence d'identifiants **/
ALTER SEQUENCE client_id_seq RESTART WITH 21;
ALTER SEQUENCE customer_order_id_seq RESTART WITH 49;
ALTER SEQUENCE order_line_id_seq RESTART WITH 121;

/** Ajout des clefs étrangères **/
ALTER TABLE customer_order ADD CONSTRAINT customer_order_fk FOREIGN KEY (client_id) REFERENCES client(id) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE order_line ADD CONSTRAINT order_line_fk FOREIGN KEY (order_id) REFERENCES customer_order(id) ON DELETE CASCADE ON UPDATE CASCADE;
